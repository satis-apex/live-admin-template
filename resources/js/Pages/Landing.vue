        ...
        <nav id="header" class="fixed w-full z-30 top-0 text-white">
            ...
            >
                ...
                >
                    ...
                    >
                        <a title="login" :href="appRoute('login')"> login </a>
                    </button>
                </div>
            </div>
            ...
            <div class="container mx-auto flex flex-wrap pt-4 pb-12">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <p
                                class="w-full text-gray-600 text-xs md:text-sm px-6"
                            >
                                xGETTING STARTED
                            </p>
                            <div
            ...
            <div class="container mx-auto px-2 pt-4 pb-12 text-gray-800">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <div
                                class="p-8 text-3xl font-bold text-center border-b-4"
                            >
                                Free
                            </div>
                    ...
                    >
                        ...
                        >
                            <div
                                class="w-full p-8 text-3xl font-bold text-center"
                            >
                                Basic
                            </div>
                            <div
                                class="h-1 w-full gradient my-0 py-0 rounded-t"
                            ></div>
                        ...
                        >
                            <div
                                class="w-full pt-6 text-4xl font-bold text-center"
                            >
                                £x.99
...
<script setup>
import { computed, ref, watch, markRaw, onMounted } from "@vue/runtime-core";
