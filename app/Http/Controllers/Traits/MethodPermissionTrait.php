...
{
	public function implementMethodPermission($permissionFor)
	{
		$this->middleware('permission:' . $permissionFor . '-list|' . $permissionFor . '-create|' . $permissionFor . '-edit|' . $permissionFor . '-delete', ['only' => ['index', 'show', 'listAll']]);
