    ...
    ElMessageBox.confirm("It will permanently delete. Continue?", "Warning", {
        ...
        callback: (action) => {
            if (action == "confirm") {
                ...
                formData.delete(route("staff.destroy", data.id), {
                    preserveScroll: true,
                    onSuccess: () => {
                        formData.reset();
                    },
...
const dataList = $ref(iPropsValue("staffList"));
const roleList = $ref(iPropsValue("roleList"));
watch(
    () => iPropsValue("staffList"),
    () => {
        ...
        "Info",
        {
            ...
            callback: (action) => {
                if (action == "confirm") {
                    ...
                    formData.post(route("staff.createAccount"), {
                        preserveScroll: true,
                        onSuccess: () => {
                            formData.reset();
                        },
        ...
        "Warning",
        {
            ...
            callback: (action) => {
                if (action == "confirm") {
                    ...
                    formData.post(route("staff.resetPassword"), {
                        preserveScroll: true,
                        onSuccess: () => {
                            formData.reset();
                        },
